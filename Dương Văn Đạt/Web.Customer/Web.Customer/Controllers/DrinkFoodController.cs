...
{
    public class DrinkFoodController : Controller
    {
        IFoodManager _manager;
        IFoodCategoryManager _cmanager;
        IDrinkManager _dmanager;
        IDrinkCategoryManager _dcmanager;
        public DrinkFoodController(IFoodManager manager, IFoodCategoryManager cmanager, IDrinkManager dmanager, IDrinkCategoryManager dcmanager)
        {
            _manager = manager;
            _cmanager = cmanager;
            _dmanager = dmanager;
