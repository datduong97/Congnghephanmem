<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Views/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="ReportDoanhThu.aspx.cs" Inherits="Admin_Reports_ReportDoanhThu" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="main" Runat="Server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="1060px">
        <LocalReport ReportPath="Admin\Reports\ReportDoanhThu.rdlc">
            <DataSources>
                <rsweb:ReportDataSource DataSourceId="DoanhThuSqlDataSource" Name="DoanhThuDataSet" />
            </DataSources>
        </LocalReport>
    </rsweb:ReportViewer>
