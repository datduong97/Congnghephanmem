<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Views/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="QLDanhmucDoUong.aspx.cs" Inherits="Admin_Views_QLDanhmucDoUong" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="main" runat="server">   
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <asp:GridView ID="gvChuyenMuc" CssClass="table table-responsive table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="idCategoryDrink" GridLines="None" PageSize="5" OnRowCommand="gvChuyenMuc_RowCommand">
                <Columns>
